    ...
    return (
        ...
        {reviews.length === 0 ? (
          ...
          <div className="space-y-4">
            {reviews.map(review => (
              <div key={review.reviewId} className="border rounded p-4 shadow flex flex-col space-y-2">
          ...
          <div className="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-50">
            <div className="bg-white p-6 rounded w-96">
              ...
              <div className="flex justify-end space-x-2">
                <button className="px-4 py-2 bg-gray-400 rounded" onClick={() => setEditingReview(null)}>Cancel</button>
                <button className="px-4 py-2 bg-blue-600 text-white rounded" onClick={saveUpdate}>Save</button>
              </div>
            </div>
          </div>
        )}
